...
public class HomeController {
	...
	public String getboard(freevo vo, Model model, FreeCommentVo cvo) {
		...
		if (board != null) {
			...
			path = "free";
			System.out.println("::: �궡�슜�씠�뾾�뒿�땲�떎 :::");
		}
		return path;
	}
	...
	public String boardcheck(HttpServletRequest req, Model model, freevo vo, String title) {
		...
		if (vo.getTitle() != "") {
			...
			map.put("cnt1", cnt1);
			System.out.println(":::吏묒뿉媛��옄:::");
		} else {
			cnt1 = "0";
			System.out.println(":::false �깘:::");
		}
		return cnt1;
	}
...
//	}
	...
	@RequestMapping(value="/testcheck.do",method=RequestMethod.GET)
	public String checksearch(HttpServletRequest req,Model model) {
		Map<String, String> champ = new HashMap<String, String>();
		champ.put("0", req.getParameter("0"));
		champ.put("1", req.getParameter("1"));
		champ.put("2", req.getParameter("2"));
		model.addAttribute("champ",champ);
		return "testcheck";
		
	}
	@RequestMapping(value ="promatch.do",method = RequestMethod.GET)
	public String promatch(Model model) {
		return "promatch";
	}
	@RequestMapping(value ="apitest.do",method = RequestMethod.GET)
	public String goapitest() {
		return "apitest";
	}
}
